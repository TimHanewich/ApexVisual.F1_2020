...
namespace ApexVisual.F1_2020.CloudStorage
{
    public static class SqlExtensions
    {
        ...
        public static void InitializeSqlTables(this ApexVisualManager avm)
        {
            ...
            {
                TableCreationCommands.Add("create table Session (SessionId varchar(30), SessionMode tinyint, SelectedTeam tinyint, SelectedDriver tinyint, DriverName varchar(255), SessionCreatedAt datetime)");
            }
